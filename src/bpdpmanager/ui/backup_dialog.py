...
class BackupBrowserDialog(QDialog):
    ...
    def __init__(self, backup_manager: BackupManager, db_path: Path, parent=None) -> None:
        ...
        self.setWindowTitle("Zálohy databáze")
        ...
        self.tree.setHeaderLabels(["Čas vytvoření", "Označení", "Velikost"])
    ...
    def _restore(self) -> None:
        ...
        try:
            ...
            QMessageBox.critical(self, "Obnova selhala", str(exc))
            return
        self.restored.emit()
        QMessageBox.information(
            self,
    ...
    def _open_folder(self) -> None:
        ...
        if not path.exists():
            QMessageBox.information(self, "Otevřít složku", "Složka záloh ještě neexistuje.")
            return
