...
**Aktuální verze: 0.5.0** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **📋 Souhrn práce**: první záložka detailu — formátovaný read-only přehled celé práce (velký barevný badge stavu, hlavička s typem/názvem/studentem/oponentem, anotace, body zadání, literární zdroje). Ideální pro rychlý vizuální audit nebo printscreen.
