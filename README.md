...
**Aktuální verze: 1.0.3** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **🧐 Oponované práce** — samostatná záložka pro práce, kde vystupuješ jako oponent (recenzuješ cizí BP/DP). Vlastní datový model — typ, rok, STAG odkaz, student + vedoucí (vedoucí přes registr s našeptáváním a auto-doplněním emailu), název CZ, body zadání, **známky vedoucího + oponenta s barevným badge**, dokumenty (plný text práce, posudek vedoucího, můj posudek oponenta), automaticky generovaný Souhrn.
