...
**Aktuální verze: 1.14.4** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **🔍 Globální vyhledávání a navigace** — pole nad záložkami najde práci napříč vedenými pracemi i oponenturami podle **jména studenta**, **názvu práce** nebo **osobního čísla (Axxxxx)**. **Našeptává v reálném čase** — stačí napsat **kousek** příjmení / názvu a hned se ukáže rozbalovací seznam pasujících prací, kde každý řádek nese **[záložku] · Vedená/Oponovaná · BP/DP · jméno studenta — název**; výběrem (Enter/klik) na práci rovnou skočíš. (Enter bez výběru / tlačítko **Najít** se chovají jako dřív — jedna shoda skočí, víc shod nabídne menu.)
