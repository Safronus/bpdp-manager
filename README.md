...
**Aktuální verze: 0.8.0** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **🔍 Plagiátorství**: u každé práce procento shody, komentář k výsledku a PDF protokol s odkazem na otevření v systémové aplikaci
