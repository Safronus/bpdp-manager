...
**Aktuální verze: 1.0.0** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **Studenti**: jméno, obor (forma studia se odvozuje z přípony `-P` / `-K`), osobní číslo UTB (např. A24390), email, telefon, poznámka. Správa studentů: strom *BP/DP → obor → studenti*, řazeno dle příjmení, barevné odlišení aktuálních/budoucích/dokončených, **real-time filtr podle příjmení** (necitlivý na diakritiku) a filtr „Skrýt dokončené".
