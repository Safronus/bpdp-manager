...
**Aktuální verze: 2.0.4** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **Přepínání jazyka CZ / EN** — tlačítko 🌐 v toolbaru (volba v profilu, projeví se po restartu); čeština výchozí, v EN je přeložená hlavní plocha (záložky, toolbar, seznamy, statistiky, stavy), zbytek se doplňuje po vlnách
