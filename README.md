...
**Aktuální verze: 0.66.0** — viz [CHANGELOG.md](CHANGELOG.md) pro historii.
...
- **Pohledy**: *Aktuální rok*, *Budoucí zájemci*, *Historie*, *Vše* — vertikální rozvržení: nahoře strom prací grupovaný *Akademický rok → BP/DP* s sloupci (Student / Téma / Stav / **Známky** V/O / Posudky / Odesláno / Oponent / Obor) a barevně odlišenými stavy, dole detail vybrané práce. *Historie* má navíc **checkboxy stavů** (*Obhájeno* / *Nedokončeno*, defaultně obě) s **perzistencí napříč restarty**
